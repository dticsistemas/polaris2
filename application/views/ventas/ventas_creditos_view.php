...
<input type="hidden" id="butt_vc_procesar"  name="butt_pedidos_procesar"  value="ok" />

<?php echo form_close(); ?>
<div class="panel panel-primary">
<div class="panel-heading">
    <h2 class="panel-title text-center">REGISTRANDO VENTA DE PRODUCTOS</h2>
</div>
...
<td class="<?=$arr_color[$indice]?>"><input type="hidden" value="<?=$pedido['id_producto']?>"
  ...
  /><input type="hidden" value="<?=$pedido['id']?>"/><input type="hidden" value="<?=$pedido['descontar_stock']?>"/><?=$pedido['id']?>
    ...
    <td><?=$pedido['estado']?></td>
    <td><?=$pedido['total']?></td>
    <td><?=$pedido['anotacion']?>a</td>
    <td>
      <button type="button" data-toggle="modal" onclick="editarProducto(<?=$i+1?>)" data-target="#myModalEdit" class="btn btn-primary btn-xs"> <span class="btn-xs glyphicon glyphicon-edit"></span>
      </button>
...
<!-----------------End Tabla Productos-------------------->
    ...
    <div class="panel-footer text-center">
        <button class="btn btn-success" type="button" onclick="validacion_formvc()" >Guardar Pedidos de productos</button>
            ...
            <!-- /.box-header -->
              <div class="form-horizontal box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" disabled class="form-control" id="edit_cantidad" >
                  </div>
                </div>
                  <div class="form-group">
                    <label class="col-sm-4 control-label">Monto</label>
                    <div class="col-sm-8">
                      <input type="text" disabled class="form-control" id="edit_precio_convenido" >
                    </div>
                  </div>
                  <div class="form-group">
