...
<!-- Main content -->
    <section class="invoice">
      ...
      <!-- info row -->
      <form class="form-horizontal"  id="ventas_formpedidos" method="post" action="<?=base_url()?>ventas/consignacion_cliente">
             <div class="row">
               <div class="col-sm-2">
               </div>
               <div class="col-sm-5">
               ...
               <div class="col-sm-2">
                 <button type="submit" name="butt_pedidos" value="ok"class="btn  btn-primary ">Gestionar Consignacion</button>
               </div>
               <div class="col-sm-2">
           ...
           <form id="ventas_formgestionconsignacion" method="post" action="<?=base_url()?>ventas/consignacion_cliente">
...
function gestionar_pedido(id_cliente){
      ...
      $('#ventas_formgestionconsignacion').submit();
